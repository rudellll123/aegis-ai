...
init_files = ["agents/__init__.py", "agents/graph/__init__.py"]
for f in init_files:
    if not os.path.exists(f):
        with open(f, "w", encoding="utf-8") as fh:
            fh.write("")

content = '''from knowledge_graph.service import Neo4jService
...
with open("agents/graph/graph_agent.py", "w", encoding="utf-8") as f:
    f.write(content)

print("Wrote agents/__init__.py, agents/graph/__init__.py, agents/graph/graph_agent.py")